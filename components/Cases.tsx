...
const DEFAULT_CASES: DisplayCase[] = [
  {
    slug: "mebli-pro",
    client: "MeblіPro",
    location: "Харків · виробник корпусних меблів",
    type: "Лендінг + Каталог",
    highlight: "+44% заявок",
    imageUrl: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=720&q=75",
    accentColor: "#C9A87C",
    desc: "Лендінг + каталог продукції для виробника корпусних меблів. Запустили онлайн-калькулятор вартості, підключили CRM. Заявки з сайту замінили рекламу у газеті та 'сарафанне радіо'.",
    stats: [{ value: "+44%", label: "заявок з сайту" }, { value: "12 дн.", label: "до запуску" }, { value: "CRM", label: "інтеграція" }],
  },
  {
    slug: "craft-interior",
    client: "CRAFT Інтер'єр",
    location: "Київ · дизайн-студія інтер'єру",
    type: "Корпоративний сайт",
    highlight: "×3.1 конверсія",
    imageUrl: "https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=720&q=75",
    accentColor: "#d4a574",
    desc: "Портфоліо-сайт для дизайн-студії: галерея проєктів із фільтрацією по стилях, форма замовлення консультації. Конверсія відвідувач → заявка зросла у 3.1 рази після редизайну.",
    stats: [{ value: "×3.1", label: "конверсія" }, { value: "9 дн.", label: "до здачі" }, { value: "95+", label: "PageSpeed" }],
  },
  {
    slug: "sofaland",
    client: "SofaLand",
    location: "Одеса · інтернет-магазин м'яких меблів",
    type: "Інтернет-магазин",
    highlight: "+2.4× продажі",
    imageUrl: "https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=720&q=75",
    accentColor: "#f59e0b",
    desc: "Інтернет-магазин на 400+ позицій: пошук по параметрах (колір, матеріал, розмір), кошик з онлайн-оплатою, інтеграція з Новою Поштою. Онлайн-продажі зросли у 2.4 рази за перший квартал.",
    stats: [{ value: "+2.4×", label: "онлайн-продажі" }, { value: "400+", label: "позицій товарів" }, { value: "NP", label: "інтеграція" }],
  },
  {
    slug: "kuhni-art",
    client: "КухніАрт",
    location: "Львів · кухні на замовлення",
    type: "Лендінг",
    highlight: "8.4% CR",
    imageUrl: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?auto=format&fit=crop&w=720&q=75",
    accentColor: "#C9A87C",
    desc: "Лендінг для виробника кухонь на замовлення з інтерактивним розрахунком вартості та галереєю готових об'єктів. Конверсія форми — 8.4%, що вдвічі вище середнього по ніші.",
    stats: [{ value: "8.4%", label: "конверсія форми" }, { value: "7 дн.", label: "до запуску" }, { value: "×2", label: "проти ніші" }],
  },
  {
    slug: "renogroup",
    client: "RenoGroup",
    location: "Дніпро · ремонт і оздоблення",
    type: "Корпоративний сайт",
    highlight: "+75 лідів/міс",
    imageUrl: "https://images.unsplash.com/photo-1484101403633-562f891dc89a?auto=format&fit=crop&w=720&q=75",
    accentColor: "#a78bfa",
    desc: "Корпоративний сайт ремонтної компанії: портфоліо з фото до/після, онлайн-заявка, відгуки з Google.Maps. Органічний трафік і Google Ads дають 75+ кваліфікованих лідів щомісяця.",
    stats: [{ value: "+75", label: "лідів / місяць" }, { value: "14 дн.", label: "розробка" }, { value: "SEO", label: "налаштовано" }],
  },
  {
    slug: "parket-house",
    client: "ПаркетХаус",
    location: "Запоріжжя · підлогові покриття",
    type: "Сайт-каталог",
    highlight: "×1.9 чек",
    imageUrl: "https://images.unsplash.com/photo-1567225557594-88d73e55f2cb?auto=format&fit=crop&w=720&q=75",
    accentColor: "#C9A87C",
    desc: "Каталог паркету і підлогових покриттів із 3D-візуалізатором, фільтрами та порівнянням товарів. Клієнт вибирає покриття самостійно — менеджер лише закриває угоду. Середній чек виріс у 1.9 рази.",
    stats: [{ value: "×1.9", label: "середній чек" }, { value: "600+", label: "позицій" }, { value: "3D", label: "візуалізатор" }],
  },
];
